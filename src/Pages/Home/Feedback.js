...
const Feedback = () => {
    return (
        <div className='flex justify-center mb-20'>
            ...
            className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-50 text-gray-800">
                <div className="flex flex-col items-center w-full">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <button type="button" className="py-4 my-8 font-semibold rounded-md text-gray-50 bg-violet-600">Leave feedback</button>
                    </div>
                </div>
